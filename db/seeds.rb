...
WorksWith.create(title:Faker::Lorem.sentence, description: Faker::Lorem.sentence, is_live: true, offering_id:1, app_id: 1, promo_text:Faker::Lorem.sentence, promo_image_url:Faker::Internet.url)
