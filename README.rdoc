...
== Admin
    1. The admin tool can be view from the app at +http://localhost:3000/admin+

== Documentation
    1. The Rdoc generated documentation can be found at +http://localhost:63342/msk-works-with/doc/index.html+

== Style Guide
    1. A style guide can be found at +http://localhost:3000/assets/styleguide.html+
