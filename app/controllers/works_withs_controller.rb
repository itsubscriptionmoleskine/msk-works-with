class WorksWithsController < ApplicationController
  ...
  def index
    ...
    @page_title = 'Works with Moleskine Smart Writing Systems'
  ...
  def works_with_params
    params.require(:works_with).permit(:title, :description, :app_id, :product_id, :is_live, :promo_image_url, :promo_text, :slug, :meta_title)
  end
end